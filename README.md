...
# 3. SSH Hardening (key-only auth, modern crypto)
...
# 5. nftables Firewall (gateways, advanced setups)
...
**Why I Built This**: After spending weeks hardening production servers to 100% CIS Benchmark compliance, I wished I could find everything in one place. This repo consolidates 12 production-tested security components so you don't have to piece together scattered documentation.
